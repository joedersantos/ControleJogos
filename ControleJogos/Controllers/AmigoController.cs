...
namespace ControleJogos.Controllers
{
    ...
    public class AmigoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Telefone")] Amigo amigo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Telefone")] Amigo amigo)
        {
            if (id != amigo.Id)
            {
                return NotFound();
